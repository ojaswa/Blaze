    ...
    ui(new Ui::DialogRaycastingSettings)
{
    ...
    ui->checkBoxDirectRGBA->setChecked(false);
    ui->checkBoxDirectRGBA->setEnabled(false);
...
void DialogRaycastingSettings::enableDirectRenderingToggle()
{
    ui->checkBoxDirectRGBA->setEnabled(true);
    ui->checkBoxDirectRGBA->setChecked(true);
}

void DialogRaycastingSettings::on_checkBoxDirectRGBA_toggled(bool checked)
{
    emit toggleDirectRGBARendering(checked);
}
